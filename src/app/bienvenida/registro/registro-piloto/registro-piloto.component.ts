...
@Component({
  ...
  styleUrls: ['./registro-piloto.component.scss']
})
export class RegistroPilotoComponent implements OnInit {
  ...
  get detallePerfil() { return this.signupForm.get('detallePerfil'); }
  ...
  ngOnInit() {
    this.signupForm = new FormGroup({
      ...
      'detallePerfil': new FormControl(null, [Validators.required, this.emptyValidator]),
